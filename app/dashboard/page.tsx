    ...
    <div className="w-full">
      ...
      >
        <h1 className="text-6xl font-black text-white mb-2 tracking-tight">
          Welcome Back, <span className="text-indigo-400 text-5xl">{userName || 'Account'}</span>
        </h1>
        <p className="text-slate-300 text-base font-normal">{quote}</p>
      </motion.div>
      ...
      {Object.entries(featuresByCategory).map(([category, features]) => (
        <div key={category} className="mb-12">
          ...
          <div className="mb-6 pb-4 border-b border-indigo-500/20">
            <span className="text-xs font-bold text-indigo-400 tracking-widest uppercase">{category}</span>
          </div>
